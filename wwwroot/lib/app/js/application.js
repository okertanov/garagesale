...
exports.CategoryModel = Backbone.Model.extend(
{
    ...
    url: function()
    {
        return '/api/category' + ( typeof this.get('_id') !== 'undefined' ? '/' + this.get('_id') : '' );
    },
    initialize: function()
    {
    },
...
exports.ItemModel = Backbone.Model.extend(
{
    ...
    url: function()
    {
        return '/api/items' + '/' + this.get('category') + ( typeof this.get('_id') !== 'undefined' ? '/' + this.get('_id') : '' );
    },
    initialize: function()
    {
    },
...
exports.CategoryView = Backbone.View.extend(
{
    ...
    render: function()
    {
        ...
        $('<a href="#">').appendTo( this.$el )
            ...
            .attr( 'href', '#category/' + this.model.get('_id') );
